// Single source of truth for the public tool directory and sitemap.
// Keep hrefs absolute so navigation works from both root and /tools/ pages.
const categories = [
  {
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'PDF Scratchpad', desc: 'Draft and organize PDF text', href: '/pdf-scratchpad.html', color: '#7c3aed', svg: '<rect x="5" y="2" width="14" height="20" rx="2"/><line x1="9" y1="8" x2="15" y2="8"/><line x1="9" y1="12" x2="15" y2="12"/><line x1="9" y1="16" x2="13" y2="16"/>' }
    ]
  },
  {
    name: 'Image and PDF',
    tools: [
      ...
      { name: 'Image Format Converter', desc: 'Convert genuine JPG, PNG and WebP outputs', href: '/tools/image-format-converter.html', color: '#0d9488', svg: '<path d="M7 7h10v10H7z"/><path d="M4 12h3M17 12h3M12 4v3M12 17v3"/>' },
      { name: 'Image Resize', desc: 'Resize images with pixel-level control', href: '/tools/image-resize.html', color: '#0d9488', svg: '<path d="M4 4h6M4 4v6M20 20h-6M20 20v-6M4 20h6M4 20v-6M20 4h-6M20 4v6"/>' },
      { name: 'WebP to JPG', desc: 'Convert WebP images to JPEG', href: '/tools/webp-to-jpg.html', color: '#0d9488', svg: '<rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/>' }
    ]
  },
  {
    name: 'Organize and Manage',
    tools: [
      { name: 'Crop PDF', desc: 'Visual crop with precision', href: '/tools/crop-pdf.html', color: '#ea580c', svg: '<path d="M6 2v14a2 2 0 0 0 2 2h14"/><path d="M18 22V8a2 2 0 0 0-2-2H2"/>' },
      { name: 'Delete PDF Pages', desc: 'Remove unwanted pages', href: '/tools/delete-pdf-pages.html', color: '#dc2626', svg: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="14" x2="15" y2="14"/>' },
      { name: 'Rotate PDF', desc: 'Fix page orientation', href: '/tools/rotate-pdf.html', color: '#ea580c', svg: '<polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/>' },
      { name: 'PDF Page Reorder', desc: 'Drag and drop rearrange', href: '/pdf-page-reorder.html', color: '#7c3aed', svg: '<rect x="6" y="2" width="12" height="5" rx="1"/><rect x="6" y="9" width="12" height="5" rx="1"/><rect x="6" y="16" width="12" height="5" rx="1"/>' },
      { name: 'PDF Bookmarks', desc: 'Add clickable navigation outlines', href: '/pdf-bookmark.html', color: '#7c3aed', svg: '<path d="M19 21l-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/>' },
      { name: 'Add Page Numbers', desc: 'Professional numbering', href: '/tools/add-page-numbers-to-pdf.html', color: '#7c3aed', svg: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="14" x2="15" y2="14"/><line x1="9" y1="17" x2="15" y2="17"/>' },
      { name: 'PDF Watermark', desc: 'Text or image watermarks', href: '/tools/pdf-watermark.html', color: '#ea580c', svg: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="6" y1="20" x2="18" y2="8" stroke-dasharray="3 2" opacity="0.5"/>' },
      { name: 'PDF Page Counter', desc: 'Count pages in multiple files', href: '/tools/pdf-page-counter.html', color: '#4f46e5', svg: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/>' },
      { name: 'Compare PDFs', desc: 'Side-by-side diff highlighting', href: '/compare-pdf.html', color: '#2563eb', svg: '<path d="M3 3h7v18H3z"/><path d="M14 3h7v18h-7z"/><line x1="5" y1="7" x2="8" y2="7"/><line x1="16" y1="7" x2="19" y2="7"/>' },
      { name: 'Highlight Extractor', desc: 'Extract notes and annotations', href: '/pdf-highlighter-extractor.html', color: '#ea580c', svg: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/>' }
    ]
  },
  {
    ...
    tools: [
      ...
      { name: 'Flatten PDF', desc: 'Remove forms, make non-editable', href: '/flatten-pdf.html', color: '#ea580c', svg: '<rect x="2" y="12" width="20" height="5" rx="1"/><path d="M12 17v5"/><polyline points="9 20 12 22 15 20"/>' }
    ]
  },
  {
  ...
  {
    name: 'Creative and Productivity',
    tools: [
      { name: 'QR Code Generator', desc: 'Create text, URL and file QR codes', href: '/tools/qr-code-generator.html', color: '#8b6914', svg: '<rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><path d="M14 14h3v3h4v4h-7z"/>' },
      { name: 'Passport Photo Maker', desc: 'Create print-ready passport photo sheets', href: '/tools/passport-photo-maker.html', color: '#7c3aed', svg: '<circle cx="12" cy="8" r="3"/><path d="M5 21a7 7 0 0 1 14 0"/>' },
      { name: 'Resume Builder', desc: 'Build a polished resume locally', href: '/resume-cv-builder.html', color: '#7c3aed', svg: '<path d="M5 3h14v18H5z"/><path d="M8 7h8M8 11h8M8 15h5"/>' },
      { name: 'Invoice Generator', desc: 'Create professional invoices in your browser', href: '/invoice-generator.html', color: '#7c3aed', svg: '<path d="M6 3h12v18l-3-2-3 2-3-2-3 2z"/><path d="M9 8h6M9 12h6M9 16h3"/>' },
      { name: 'Speech to Text', desc: 'Transcribe speech and export Unicode PDFs', href: '/speech-to-text.html', color: '#d97706', svg: '<rect x="9" y="3" width="6" height="12" rx="3"/><path d="M5 11a7 7 0 0 0 14 0M12 18v3M8 21h8"/>' },
      { name: 'Text to Speech', desc: 'Listen to text with browser voices', href: '/text-to-speech.html', color: '#d97706', svg: '<path d="M4 9v6h4l5 4V5L8 9z"/><path d="M17 9a4 4 0 0 1 0 6M19 6a8 8 0 0 1 0 12"/>' },
      { name: 'Remove Background', desc: 'AI-assisted background removal with provider disclosure', href: '/remove-background.html', color: '#d97706', svg: '<path d="M4 4h16v16H4z"/><path d="M4 16l5-5 3 3 3-4 5 6"/>' },
      { name: 'Presentation Maker', desc: 'Create presentation slides from templates', href: '/presentation-maker.html', color: '#2563eb', svg: '<rect x="3" y="4" width="18" height="13" rx="2"/><path d="M8 21h8M12 17v4"/>' }
    ]
  }
];
